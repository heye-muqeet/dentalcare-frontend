            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  {branch.branchAdmins && Array.isArray(branch.branchAdmins) && branch.branchAdmins.length > 0 ? (
                    <div className="space-y-3">
                      {branch.branchAdmins.map((admin, index) => (
                        <div key={admin._id || index} className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center space-x-2">
                              <p className="font-medium text-gray-900">
                                {String(admin.firstName || '')} {String(admin.lastName || '')}
                              </p>
                            ...
                            <p className="text-sm text-gray-600">{String(admin.email || '')}</p>
                            {admin.phone && (
                              <p className="text-sm text-gray-600">{String(admin.phone)}</p>
                            )}
                    ...
                    <div className="text-center py-6 bg-gray-50 rounded-lg">
                      ...
                      <p className="text-sm text-gray-500">No branch administrators assigned</p>
                      <p className="text-xs text-gray-400">Branch admins can be assigned when the branch is active</p>
                    </div>
                  )}
                </div>
